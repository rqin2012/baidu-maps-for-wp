...
<div id="primary">
    ...
    <?php
    $mypost = array( 'post_type' => 'baidu_maps', );
    ...
    <?php while ( $loop->have_posts() ) : $loop->the_post();?>
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <header class="entry-header">
                ...
                <!-- Display Post Title and map Name -->
                <strong>Title: </strong><?php the_title(); ?><br />
                <strong>Map Name: </strong>
                <?php echo esc_html( get_post_meta( get_the_ID(), 'baidu_map_name', true ) ); ?>
                <br />
                
 				<!-- Display custom taxonomy -->
 				<strong>Map Type: </strong>
                <?php  
                the_terms( $post->ID, 'baidu_maps_type' ,  ' ' );
				?>
                <br />
